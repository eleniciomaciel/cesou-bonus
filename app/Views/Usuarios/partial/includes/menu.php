<div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="/user">
        ...
        <img src="<?= base_url() ?>/assets/images/logo-principal-96x52.png" class="navbar-brand-img h-100" alt="main_logo">

        <span class="ms-1 font-weight-bold">Cestou Descontos</span>
    </a>
</div>
...
<div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link  <?= url_is('user') == 'user' ? 'active' : null ?>" href="/user">
                ...
                <span class="nav-link-text ms-1">Painel de atividades</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link <?= url_is('user/bradesco-express') == 'user/bradesco-express' ? 'active' : null ?>" href="/user/bradesco-express">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <span class="nav-link-text ms-1">Bradesco Express</span>
            </a>
        </li>

        <li class="nav-item">
            <a class="nav-link <?= url_is('user/leva-e-traz') == 'user/leva-e-traz' ? 'active' : null ?>" href="/user/leva-e-traz">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <span class="nav-link-text ms-1">Leva e Traz</span>
            </a>
        </li>

        <li class="nav-item">
            <a class="nav-link <?= url_is('user/shopping-cashback') == 'user/shopping-cashback' ? 'active' : null ?>" href="/user/shopping-cashback">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <span class="nav-link-text ms-1">Cadastar Cupom</span>
            </a>
        </li>

        <li class="nav-item">
            <a class="nav-link <?= url_is('user/pontos-desconto') == 'user/pontos-desconto' ? 'active' : null ?>" href="/user/pontos-desconto">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <span class="nav-link-text ms-1">Programa de Pontos</span>
            </a>
        </li>

        <li class="nav-item mt-3">
            <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Dados da conta</h6>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="javascript:;" data-bs-toggle="modal" data-bs-target="#modal-form">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
