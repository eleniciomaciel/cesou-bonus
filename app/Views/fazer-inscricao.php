        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-5 text-center mx-auto">
              ...
              <p class="text-lead text-white">Preencha os campos para participar do projeto Cestou.Top.</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
            <div class="card z-index-0">
              ...
              <div class="card-body">
                ...
                <?= form_open('login/registra-acesso', 'role="form text-left" id="cadastra_usuario"') ?>

                  <div class="mb-3">
                    <label for="">NOME COMPLETO:</label>
                    <input type="text" style="text-transform: uppercase" class="form-control" name="reg_nome" id="reg_nome" placeholder="Ex.: Ana Silva" required>
                    <span class="text-danger error-text reg_nome_error"></span>
                  </div>

                  <div class="mb-3">
                    <label for="">TELEFONE:</label>
                    <input type="tel" class="form-control" name="reg_telefone" id="reg_telefone" placeholder="Ex.: (74)9 9999-9999" required>
                  ...
                  <div class="mb-3">
                    <label for="">CEP:</label>
                    <input type="text" class="form-control" name="reg_cep" id="reg_cep" placeholder="Ex.: 99.999-999" required>
                    <span class="text-danger error-text reg_cep_error"></span>
                  </div>

                  <div class="mb-3">
                    <label for="">UF:</label>
                    <input type="text" style="text-transform: uppercase" maxlength="2" class="form-control" name="reg_uf" id="reg_uf" placeholder="Ex.: BA" readonly>
                    <span class="text-danger error-text reg_uf_error"></span>
                  </div>

                  <div class="mb-3">
                    <label for="">CIDADE:</label>
                    <input type="text" style="text-transform: uppercase" class="form-control" name="reg_cidade" id="reg_cidade" placeholder="Ex.: Senhor do Bonfim" readonly>
                    <span class="text-danger error-text reg_cidade_error"></span>
                  </div>

                  <div class="mb-3">
                    <label for="">BAIRRO:</label>
                    <input type="text" style="text-transform: uppercase" class="form-control" name="reg_bairro" id="reg_bairro" placeholder="Ex.: Centro" required>
                    <span class="text-danger error-text reg_bairro_error"></span>
                  </div>

                  <div class="mb-3">
                    <label for="">ENDEREÇO:</label>
                    <input type="text" style="text-transform: uppercase" class="form-control" name="reg_endereco" id="reg_endereco" placeholder="Ex.: Rua 13 de Maio" required>
                    <span class="text-danger error-text reg_endereco_error"></span>
                  </div>
                  <div class="mb-3">
                    <label for="">EMIAL PESSOAL:</label>
                  ...
                  <div class="text-center">
                    <button type="submit" class="class_load_envia btn bg-gradient-dark w-100 my-4 mb-2" id="id_btn_load">Salvar</button>
                  </div>
          ...
          if (validacep.test(cep)) {
            ...
            $.getJSON("https://viacep.com.br/ws/" + cep + "/json/?callback=?", function(dados) {
              ...
              if (!("erro" in dados)) {
                ...
                $("#reg_endereco").val(dados.logradouro);
                $("#reg_bairro").val(dados.bairro);
                $("#reg_cidade").val(dados.localidade);
                $("#reg_uf").val(dados.uf);
              } //end if.
              else {
