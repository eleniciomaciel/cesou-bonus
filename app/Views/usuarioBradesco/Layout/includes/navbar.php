<ul class="navbar-nav">
    <li class="nav-item">
        <a class="nav-link  active" href="/bradesco_panel">
    ...
    <li class="nav-item">
        <a class="nav-link  " href="/bradesco_panel/atendidos">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Atendidos</span>
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link  " href="#">
            ...
            <span class="nav-link-text ms-1">Cancelados</span>
        </a>
    </li>


    <li class="nav-item mt-3">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Dados pessoal</h6>
    </li>
    <li class="nav-item">
        <a class="nav-link  " href="#">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
